...
public class ObstacleGenerator : MonoBehaviour
{
    ...
    private Vector2 getRandomPos()
    {
        ...
        Vector2 xRange = new Vector2(-IceLandGenerator.LAND_WIDTH / 2.0f, IceLandGenerator.LAND_WIDTH / 2.0f);
    ...
    private GameObject genObject(GameObject ob)
    {
    ...
    private void genSmall()
    {
        ...
        GameObject ob = genObject(smalls[index]);
    }
    ...
    private void genBig()
    {
        ...
        GameObject ob = genObject(bigs[index]);
    }
    ...
    private void genlantern()
    {
        ...
        lanterncd = 0;
        GameObject ob = genObject(lanterns);
    ...
    private void genLand()
    {
        ...
        GameObject ob = genObject(lands[index]);
    }
}
